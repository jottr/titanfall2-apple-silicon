...
| `There is no Windows program configured to open this type of file` | Same cause. The supervisor repairs it within seconds; double-click the wrapper again. If it persists, run `./bootstrap.sh ea-bypass` |
